...
export default function ProjectLayout({
    ...
    if (!project) {
        return <div className="flex h-screen items-center justify-center text-black">
    ...
    return (
        <div className="">
            <nav className="flex h-[45px] items-center justify-between border-b border-gray-200 px-8">
                <Link href="/management/projects" className="text-black flex flex-row gap-2 items-center cursor-pointer ">
                    <MoveLeftIcon className="w-4 h-4" />
                    <p className="text-sm hover:underline underline-offset-4">Projectos</p>
                </Link>
            ...
            <main className="flex-1 bg-white px-8 pt-4">{children}</main>
        </div>
    );
}