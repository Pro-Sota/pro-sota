...
export default function ProjectSideBar() {
  ...
  return (
    <aside className="hidden h-full min-h-0 w-80 shrink-0 flex-col overflow-hidden border-l border-slate-200 bg-white xl:flex">
      {/* Header */}
      <header className="flex h-[73px] shrink-0 items-center justify-center border-b border-[#BD9655] bg-white px-6">
